About qiskit-optimization-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/qiskit-optimization-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qiskit-optimization-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add qiskit-optimization
# for installing globally
pixi global install qiskit-optimization
```
...
It is possible to list all of the versions of `qiskit-optimization` available on your platform:
...
```
pixi search qiskit-optimization --channel conda-forge
```
